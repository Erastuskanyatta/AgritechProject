...
//     " displaying product with respect to Category Name"
//    @GetMapping("displayingProductsWithRespectToCategory/{categoryName}")
//    public  ResponseEntity<?>displayProductsWithRespectToCategory(@PathVariable String categoryName){
//        Map<String, Object> displayingProducts = new HashMap<>();
//
//    }
